...
- Assuming plan and test cases are correct
    ...
    {std_input_prompt}
- If plan is wrong mention `<<Wrong Plan Need Modification>>`. No need to generate code in this case.
- If any test case has problem mention `<<Wrong Test Case Need Modification>>`. No need to generate code in this case."""


prompt_for_additional_io_improvement = """# Problem:
```python
{problem}
```
# Test Cases
...
- Suppose you are a tester, your task is to create comprehensive unit test cases for given programming problem.
- The unit test cases must contain both **Normal** and **Edge** case scenarios to ensure the correctness of the code.
- I have somr test cases where some of them are wrong. Please correct the test cases.
