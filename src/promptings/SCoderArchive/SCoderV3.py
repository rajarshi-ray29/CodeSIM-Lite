...
----------------
Instructions: 
- Suppose you are a program tester, your task is to create comprehensive test cases for a programming problem.
...
prompt_for_code_generation = """{problem_with_planning}
...
- Your response must contain the modified {language} code inside ``` block. Do not include any other ``` block in your response.
{std_input_prompt}"""
