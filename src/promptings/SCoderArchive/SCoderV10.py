...
- General Guideline: For precise mathematical calculations use `Decimal` library.
{std_input_prompt}"""
...
```
[Your detailed, step-by-step plan. Plan must be inside a triple backtick (```) block]
```
"""
...
- Focus on accurately implementing the plan.
...
1. **Simulation**
    ...
    - Simulate the sample input where it fails according to your plan.
